...
public class Metodo_Jacobi {
	...
	public static void main(String[] args) {
		...
		int n = 0, i =0, j = 0, dominante = 0, R = 0;
		...
		//Registra los coeficientes de las ecuaciones en a[i][j], los terminos independientes en b[i] e inicializar las variables x[i] = 0
		i = 1;
		while (i <= n) {
			...
			while (i <= n) {
				...
				while (j <= n) {
					if (i == j) {
						...
						acumulado = acumulado - a[i][j]*xa[j];
					}
					j++;
				}
